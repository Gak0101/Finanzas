      ...
      <div className="mt-5 grid gap-3 lg:grid-cols-2">
        <div className={`rounded-lg border p-4 ${portfolioReturnPct !== null && portfolioReturnPct < 0 ? 'border-rose-200 bg-[#fff1f0]' : 'border-emerald-200 bg-[#eef6e5]'}`}>
          <div className="flex items-start justify-between gap-3">
            <div><p className="text-[10px] font-bold uppercase tracking-[0.14em] text-slate-400">Cartera completa</p><p className="mt-1 text-sm font-semibold">Rentabilidad actual · desde el coste</p></div>
